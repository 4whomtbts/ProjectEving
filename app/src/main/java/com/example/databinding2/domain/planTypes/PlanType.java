...
public class PlanType extends BaseObservable {
   ...
   // private static ArrayList<Integer> TYPICAL_MODE = {2,5,8,15,31,91,121};
    ...
    public static PlanType[] getDefaultPlanTypes(){
        ...
        array[0] = new PlanType("1/4/7/14 모드",true,typicalModeArr,firstSuggestions).setIsStudyPlan(true);
        ...
        array[1] = new PlanType("세밀계획모드",true,denseModeArr,secondSuggestions).setIsStudyPlan(true);
